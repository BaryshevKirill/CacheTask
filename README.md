...
Добавление в кеш если он не заполнен полностью: O(log n)
Добавление в кеш если он заполнен полностью: O(log n) + O(log n)  (Вставка и удаление)
Удаление  O(log n)
...
Удаление O(n) + O(log n) + O(log n) (найти минимальный + удалить из 2ух мап)
Получение элемента O(log n)
